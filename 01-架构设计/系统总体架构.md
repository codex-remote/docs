...
> [!important] 当前实现与目标架构
> 当前可运行基线包括三端 MVP、Mobile Web Gateway、Runtime Auth、Runtime v1 主链和 Admin/Diagnostics 本地闭环。稳定公网入口、SLS 和完整用户管理仍是目标能力，在完成验证前不得标记为已上线。
...
公网 Runtime 需要稳定 Origin、受控 Connector 和独立安全验收，具体方案另行设计。
